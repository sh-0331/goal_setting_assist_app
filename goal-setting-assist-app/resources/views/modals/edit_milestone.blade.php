        ...
        <div class="modal-content">
            ...
            <form action="{{ route('milestones.update', [$goal, $solution, $milestone]) }}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" class="form-control" id="edit_milestone_content" name="content" value="{{$milestone->content}}">
                    <!-- マイルストーンの期日を設定する -->
                    <label for="edit_milestone_date" class="form-label">マイルストーンは何日で完了できますか。<br>
                        <span class="text-danger">※7日以内で入力してください</span></label>
                    <input type="text" class="form-control" id="edit_milestone_date" name="date" placeholder="日" value="{{$milestone->date}}">
                </div>
